...
(function () {
  ...
  function Runner(outerContainerId, opt_config) {
    ...
    // set styles
    Object.assign(this.outerContainerEl.style, {
  ...
  Runner.prototype = {
    ...
    loadImages: function () {
      ...
      for (var i = numImages - 1; i >= 0; i--) {
        ...
        var img = new Image();
        img.src = Runner.IMAGE_RESOURCES[imgSource.id];
        this.images[imgSource.name] = img;
      }
    },
    /**
    ...
    loadSounds: function () {
      if (!IS_IOS) {
        ...
        for (var sound in Runner.sounds) {
          var soundSrc = Runner.AUDIO_RESOURCES[Runner.sounds[sound]];
